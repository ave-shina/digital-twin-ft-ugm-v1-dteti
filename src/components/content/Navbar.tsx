...
export default function Navbar() {
  ...
  // Optimize scroll handler with useCallback + requestAnimationFrame throttle
  ...
  return (
    <div className={getNavbarClasses()}>
      ...
      <div className='flex flex-row space-x-2'>
        ...
        <button onClick={handleClose} aria-label='Kembali ke beranda' className={getButtonClasses()}>
