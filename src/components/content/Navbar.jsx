  ...
  return (
    <div
      className={clsx(
        ...
        (scrollY < screenHeight && navigation.theme === 'dark' && navigation.content === 'location') ||
          (scrollY < screenHeight && navigation.theme === 'light' && navigation.content === 'location')
          ? ' bg-transparent'
        ...
        <div className={clsx('relative mr-2 h-12 w-12 ')}>
          <Image
            src={
              (scrollY < screenHeight && navigation.theme === 'dark' && navigation.content === 'location') ||
              (scrollY < screenHeight && navigation.theme === 'light' && navigation.content === 'location')
                ? '/img/logo/logo-teknik-filled-white.svg'
                : navigation.theme === 'dark'
                ? '/img/logo/logo-teknik-filled-white.svg'
                : '/img/logo/logo-teknik-filled-black.svg'

              // navigation.theme === 'dark' || navigation.content === 'location'
              //   ? '/img/logo/logo-teknik-filled-white.svg'
              //   : '/img/logo/logo-teknik-filled-black.svg'
            }
      ...
      <div className='flex flex-row space-x-2'>
        ...
        <button
          ...
          {navigation.music ? (
            ...
            <svg width='2y' height='20' viewBox='0 0 22 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
              <path
