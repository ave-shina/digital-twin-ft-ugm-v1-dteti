...
import type { AboutContent, SiteSettings } from './prismic'
...
export interface SceneProps {
  ...
  introduction: string
  showTooltip?: boolean
  /** Data landmark dari Prismic (getStaticProps). */
...
export interface MapProps {
  ...
  /** Data landmark dari Prismic — pin merah denah tour. */
  landmarksData: LandmarksData
}
...
/** Props komponen Content (penerus konten dari halaman). */
...
/** Props komponen per-konten. */
export interface TourContentProps {
  tour: TourDataShape
  landmarksData: LandmarksData
}

export interface LandmarkContentProps {
  landmarks: LandmarksData
}
