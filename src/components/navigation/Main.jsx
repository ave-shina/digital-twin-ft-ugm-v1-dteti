  ...
  return (
    <div
      ...
      <button
        ...
        className={clsx(
          'show-tooltip group flex h-10 w-10 cursor-pointer items-center  justify-center  rounded-full hover:bg-white sm:h-12 sm:w-12  ',
        )}>
      ...
      <button
        ...
        className={clsx(
          'jelajah-teknik group flex h-10 w-10 cursor-pointer items-center  justify-center  rounded-full hover:bg-white sm:h-12 sm:w-12 ',
        )}>
        <svg width='30' height='24' viewBox='0 0 35 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <button
        ...
        className={clsx(
          'faq group flex h-10 w-10 cursor-pointer items-center  justify-center  rounded-full hover:bg-white sm:h-12 sm:w-12 ',
        )}>
        <svg width='25' height='26' viewBox='0 0 27 26' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
