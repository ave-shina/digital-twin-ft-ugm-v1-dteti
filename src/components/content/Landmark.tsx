...
import type { SceneInformation, LandmarkContentProps } from '../../types/components'
import { sanitizeHtml } from '@/utils/sanitize'
import { useSettings } from '@/context/SettingsContext'

export default function Landmark({ landmarks: Landmarks }: LandmarkContentProps) {
  ...
  // (lowercase di kedua sisi agar URL yang diketik manual tetap cocok)
  ...
  // Isi catatan dari Prismic (site_settings.catatan.landmark).
  const Message = () => (
    <div className='mb-4 text-base leading-6 text-white'>
      ...
      <div dangerouslySetInnerHTML={{ __html: sanitizeHtml(settings.catatan.landmark) }} />
    </div>
  )
